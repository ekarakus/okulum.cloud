...
CREATE TABLE IF NOT EXISTS `devices` (
  ...
  CONSTRAINT `devices_ibfk_107` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `devices_ibfk_108` FOREIGN KEY (`device_type_id`) REFERENCES `device_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `devices_ibfk_109` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `device_features` (
  ...
  CONSTRAINT `device_features_ibfk_67` FOREIGN KEY (`device_id`) REFERENCES `devices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `device_features_ibfk_68` FOREIGN KEY (`feature_id`) REFERENCES `features` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- okul_yonetim.employee_types: ~5 rows (yaklaşık) tablosu için veriler indiriliyor
...
CREATE TABLE IF NOT EXISTS `operations` (
  ...
  KEY `school_id` (`school_id`),
  CONSTRAINT `operations_ibfk_143` FOREIGN KEY (`operation_type_id`) REFERENCES `operation_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `operations_ibfk_144` FOREIGN KEY (`technician_id`) REFERENCES `technicians` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `operations_ibfk_145` FOREIGN KEY (`device_id`) REFERENCES `devices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `operations_ibfk_146` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- okul_yonetim.permissions: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- okul_yonetim.schools: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
CREATE TABLE IF NOT EXISTS `school_employees` (
  ...
  CONSTRAINT `school_employees_ibfk_13` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `school_employees_ibfk_14` FOREIGN KEY (`employee_type_id`) REFERENCES `employee_types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- okul_yonetim.users: ~3 rows (yaklaşık) tablosu için veriler indiriliyor
INSERT INTO `users` (`id`, `name`, `role`, `email`, `password`, `is_active`, `last_login`, `created_at`, `updated_at`) VALUES
	(2, 'E. Karaku??', 'super_admin', 'ekarakus@btofis.com', '$2b$10$72/MtpHt7A9sqHdXjsQVL.bTluzkbpRyXvVb/zDd1Rv1Vg.S36KAC', 1, '2025-10-12 18:27:17', '2025-10-06 06:58:54', '2025-10-12 18:27:17'),
...
CREATE TABLE IF NOT EXISTS `user_schools` (
  ...
  KEY `school_id` (`school_id`),
  CONSTRAINT `user_schools_ibfk_63` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_schools_ibfk_64` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_tr_0900_ai_ci;

-- okul_yonetim.user_schools: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
