...
CREATE TABLE IF NOT EXISTS `devices` (
  ...
  UNIQUE KEY `identity_no_3` (`identity_no`),
  UNIQUE KEY `identity_no_4` (`identity_no`),
  UNIQUE KEY `identity_no_5` (`identity_no`),
  UNIQUE KEY `identity_no_6` (`identity_no`),
  UNIQUE KEY `identity_no_7` (`identity_no`),
  UNIQUE KEY `identity_no_8` (`identity_no`),
  UNIQUE KEY `identity_no_9` (`identity_no`),
  UNIQUE KEY `identity_no_10` (`identity_no`),
  UNIQUE KEY `identity_no_11` (`identity_no`),
  UNIQUE KEY `identity_no_12` (`identity_no`),
  UNIQUE KEY `identity_no_13` (`identity_no`),
  UNIQUE KEY `identity_no_14` (`identity_no`),
  UNIQUE KEY `identity_no_15` (`identity_no`),
  UNIQUE KEY `identity_no_16` (`identity_no`),
  UNIQUE KEY `identity_no_17` (`identity_no`),
  UNIQUE KEY `identity_no_18` (`identity_no`),
  UNIQUE KEY `identity_no_19` (`identity_no`),
  UNIQUE KEY `identity_no_20` (`identity_no`),
  UNIQUE KEY `identity_no_21` (`identity_no`),
  UNIQUE KEY `identity_no_22` (`identity_no`),
  UNIQUE KEY `identity_no_23` (`identity_no`),
  UNIQUE KEY `identity_no_24` (`identity_no`),
  UNIQUE KEY `identity_no_25` (`identity_no`),
  UNIQUE KEY `identity_no_26` (`identity_no`),
  UNIQUE KEY `identity_no_27` (`identity_no`),
  UNIQUE KEY `identity_no_28` (`identity_no`),
  UNIQUE KEY `identity_no_29` (`identity_no`),
  UNIQUE KEY `identity_no_30` (`identity_no`),
  UNIQUE KEY `identity_no_31` (`identity_no`),
  UNIQUE KEY `identity_no_32` (`identity_no`),
  UNIQUE KEY `identity_no_33` (`identity_no`),
...
INSERT INTO `devices` (`id`, `identity_no`, `name`, `serial_no`, `user`, `status`, `location_id`, `device_type_id`, `school_id`, `created_at`, `updated_at`, `remark`) VALUES
	...
	(10, '129-DSK-1', 'Memur1', '', 'Hazel Ba??aran', 'active', 13, 1, 1, '2025-10-06 11:10:10', '2025-10-06 11:10:10', NULL),
